...
const CHATS = {
  qing: [
    ...
    { mine: true, name: '姚如月', text: <>对，<Keyword>我现在的生日款</Keyword>很好看，就是款式复杂差点没赶上生日宴</> },
    { name: '青青', text: '确实，难免的' },
    { name: '青青', text: <>你今年运气不错，生日就在<Keyword>周末</Keyword></> },
  ...
  mom: [
    { date: '1.13' },
    { name: '妈妈', text: '天气泠多穿-点' },
    { mine: true, name: '姚如月', text: '好，你们也注意保暖' },
    { date: '2.10' },
    { name: '妈妈', text: '闰女，票买了没' },
    { mine: true, name: '姚如月', text: '妈你打错了，是闺女。买好了，16号下午2点到' },
    { name: '妈妈', text: '0' },
    { date: '3.2' },
    { name: '妈妈', text: <>今年你<Keyword>本命年</Keyword>，妈妈给你只了红袜子寄过去了</> },
    { mine: true, name: '姚如月', text: '收到啦～爱你妈妈' },
    { name: '妈妈', text: '你爸前两天皿压又高了让他少喝酒' },
    { mine: true, name: '姚如月', text: '爸是老毛病了，让他注意点，我晚点打电话给他念叨。' },
    { date: '16:39' },
    { name: '妈妈', text: '闰女搬家完了没有' },
    { mine: true, name: '姚如月', text: '安顿得差不多啦，就是东西还没归位。' },
    { name: '妈妈', text: '要不要过去帮你收拾' },
    { mine: true, name: '姚如月', text: '不用啦，我自己慢慢弄就好啦～' },
    { name: '妈妈', text: '记按时吃饭，别老点外卖' },
  ...
  caiqing: [
    { date: '今天' },
    { mine: true, name: '姚如月', text: '采晴！！真的是你吗？没想到这么多年了还能找到你 T^T' }, { name: '采晴', text: '呜呜呜如月！我也超想你！你是怎么找到我的微信号的啊' },
    { mine: true, name: '姚如月', text: '最近搬家翻到了小学的同学录才看到你留的奥比岛号，一路找过来的' },
    { mine: true, name: '姚如月', text: '当年没有手机电脑，什么联系方式都没留下，还好你同学录上面留了一点线索' },
    { name: '采晴', text: '天哪，奥比岛，好怀念！' },
    { name: '采晴', text: '你现在过得怎么样？' },
    { mine: true, name: '姚如月', text: '在上班哈哈，上周刚搬了新家。你呢？' },
    { name: '采晴', text: '哈哈我也是打工人一枚 ~~' },
    { mine: true, name: '姚如月', text: '我在找线索的时候，发现你和梦和之前闹了一些矛盾，是什么情况啊' },
    { name: '采晴', text: '害，你知道你当时为什么会突然转学走吗' },
    { mine: true, name: '姚如月', text: '嗯，是因为梦和他爸对吧' },
    { name: '采晴', text: '是的，高一那年我和她因为这个吵了一架，之后就没再说过话了' },
    { name: '采晴', text: '她当时一直在跟我道歉，说没想到她爸爸会直接把你爸妈调走，自己一直觉得很内疚' },
    { name: '采晴', text: '但我当时气在头上，没听她解释，对她一直冷处理' },
    { name: '采晴', text: '后面过了几年我回想的时候，感觉她应该有她的苦衷……但我后面都联系不上她了' },
    { name: '采晴', text: '她本来就不是很经常用社交网络，也没留其他联系方式。我发 QQ 好友申请，她也一直不回复。' },
    { mine: true, name: '姚如月', text: '原来是这样……' },
    { mine: true, name: '姚如月', text: '我也很想知道真相，我会去找她的联系方式的' },
    { name: '采晴', text: '如果你能找到她，一定告诉我' },
    { mine: true, name: '姚如月', text: '如果找到了，你会原谅她吗' },
    { name: '采晴', text: '如果她真的是迫不得已，那我会选择原谅' },
  ],
}
