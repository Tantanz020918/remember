...
export const DECODE_FLOORS = [
  ...
  {
    avatarFrom: '#c1e8ff', avatarTo: '#6ec4f7', userName: '技术小达人', userLv: 'Lv.20', userSign: '版主',
    meta: '2 楼 · 2013-04-22 19:33',
    content: (
      <>
        <p>这是典型的编码错误，UTF-8 的文字被用 GBK 的方式打开了，所以变成了乱码。还有其他类型的编码都可能出现错乱的情况。</p>
        <p className="mt-2">你可以去网上搜一下<Keyword>在线乱码恢复工具</Keyword>，把这段乱码贴进去就能看到原文了。</p>
      </>
    ),
  },
  {
    avatarFrom: '#ffe7b3', avatarTo: '#ffb86b', userName: '小糊涂', meta: '3 楼 · 2013-04-22 20:15',
    content: <p>大佬能不能直接帮我解一下呀，我不太会弄这些工具……</p>,
    subReplies: [
      { userName: '技术小达人', replyTo: '小糊涂', content: '自己去搜，上面说了方法了。' },
    ],
  },
  {
    avatarFrom: '#d4f0c2', avatarTo: '#8cd07d', userName: '路过的', meta: '4 楼',
    content: <p>学到了学到了！</p>,
  },
]
