export function BaitianFrame({ children }) {
  return (
    <div className="flex min-h-full bg-linear-to-b from-[#fef5f8] via-[#fef0f5] to-[#fde8ee]">
      <div className="flex-1 min-w-0 py-5 px-3.5">
        <div className="bg-white rounded-lg px-5 py-3.5 mb-3 border-2 border-[#ffb8d4]">
          <div className="text-lg font-bold text-[#d16b8a] mb-2.5">🌸 百田圈圈 · 奥比岛圈</div>
